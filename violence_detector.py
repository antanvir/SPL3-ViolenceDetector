...
class ViolenceDetector:
    ...
    def prepareDataset(self, url):
        ...
        startingFrame = (35 * fps) if (total_frames/fps) >= 100.0 else (15 * fps)
        print("\n== == == ==\n")
        ...
        if len(input_video_data) >= 1:
            ...
            for frameIndex, pair in enumerate(prediction):
                ...
                if pair[1] - pair[0] >= 0.965:
                    violence_flag = True
                    self.timeOfViolences.add( int( (self.frame_nums[frameIndex]/fps) / 60) )
            ...
            print(self.resultType, " - ", self.timeOfViolences)
        else:
            print("\nThis video is NOT violent")
